...
> **Status:** 🟢 Operasional Aktif (In-House Sinergi)  
> **Tujuan:** Menyuplai seluruh kebutuhan kemasan & unboxing experience TeeStock dengan menekan biaya ke HPP riil sekaligus membentuk portofolio nyata cetak kemasan bagi MultiGraph.

---

## 1. Daftar Produk & Spesifikasi Kemasan untuk TeeStock
...
## 2. Kalkulasi Total Paket Kemasan per Kaos (BOM TeeStock)

Dengan disuplai langsung oleh MultiGraph:
- **Polymailer Sablon Logo:** Rp 1.200
- **Stiker Vinyl Bonus Unboxing:** Rp 600
- **Care Card & Voucher A6:** Rp 750
- **Hangtag Distro (Opsional Batch):** Rp 450
- **Total Biaya Packing Lengkap (BOM):** **Rp 2.550 – Rp 3.000 / pcs**

*(Jika memesan ke percetakan pihak ketiga di marketplace, biaya satu paket unboxing ini berkisar Rp 4.500 – Rp 5.500 / pcs. Terjadi penghematan Rp 2.000–Rp 2.500 per kaos yang langsung menambah profit bersih TeeStock).*

---

## 3. Manfaat Strategis untuk MultiGraph

1. **Portofolio Nyata:** Hasil cetak stiker dan kemasan yang sudah terpasang di paket TeeStock difoto untuk konten media sosial MultiGraph (`@multigraph.id`).
2. **Uji Mesin & SOP:** Melatih efisiensi alur potong, laminasi, dan cetak sebelum membuka open order ke UMKM kuliner, distro lain, dan merchandise komunitas.
3. **Arus Kas Awal:** MultiGraph mendapatkan margin operasional dari pasokan internal tanpa perlu biaya akuisisi pelanggan (Zero Customer Acquisition Cost).
