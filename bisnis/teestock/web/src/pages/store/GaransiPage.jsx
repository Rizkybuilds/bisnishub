    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 space-y-16">
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-2xl bg-[#141312] border border-white/[0.08] space-y-3">
          ...
          <div className="p-6 rounded-2xl bg-[#141312] border border-white/[0.08] space-y-3">
            ...
            <h3 className="font-bold text-base text-white">Garansi Ganti Baru Cacat Sablon</h3>
            <p className="text-xs text-ts-kremMuted leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-[#141312] border border-white/[0.08] space-y-3">
            ...
            <h3 className="font-bold text-base text-white">Salah Ukuran / Salah Kirim</h3>
            <p className="text-xs text-ts-kremMuted leading-relaxed">
        ...
        {/* Syarat Klaim Retur */}
        <div className="p-5 rounded-2xl bg-white/[0.03] border border-white/[0.08] text-xs text-ts-kremMuted space-y-2">
      ...
      <section className="space-y-6">
        ...
        {/* Size Table */}
        <div className="overflow-x-auto rounded-2xl border border-white/[0.08] bg-[#141312]">
          <table className="w-full text-left text-xs">
            ...
            <tbody className="divide-y divide-white/[0.06] text-ts-kremMuted font-mono">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-ts-kremMuted">
          <div className="p-4 rounded-xl bg-[#141312] border border-white/[0.06] space-y-1">
            <span className="font-bold text-white block">💡 Tips Fit Streetwear / Oversize:</span>
          ...
          <div className="p-4 rounded-xl bg-[#141312] border border-white/[0.06] space-y-1">
            <span className="font-bold text-white block">📐 Toleransi Jahitan Pabrik:</span>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="p-5 rounded-2xl bg-[#141312] border border-white/[0.08] space-y-2">
            <div className="text-ts-terracotta font-mono font-bold text-xs">ATURAN // 01</div>
            <h4 className="font-bold text-sm text-white">Balik Kaos Saat Dicuci (Inside-Out)</h4>
            <p className="text-xs text-ts-kremMuted leading-relaxed">
          ...
          <div className="p-5 rounded-2xl bg-[#141312] border border-white/[0.08] space-y-2">
            ...
            <h4 className="font-bold text-sm text-white">Hindari Pemutih &amp; Air Sangat Panas</h4>
            <p className="text-xs text-ts-kremMuted leading-relaxed">
          ...
          <div className="p-5 rounded-2xl bg-[#141312] border border-white/[0.08] space-y-2">
            ...
            <h4 className="font-bold text-sm text-white">PANTANG Setrika Langsung Permukaan Sablon</h4>
            <p className="text-xs text-ts-kremMuted leading-relaxed">
          ...
          <div className="p-5 rounded-2xl bg-[#141312] border border-white/[0.08] space-y-2">
            ...
            <h4 className="font-bold text-sm text-white">Jemur di Tempat Teduh</h4>
            <p className="text-xs text-ts-kremMuted leading-relaxed">
      ...
      <div className="p-8 rounded-3xl bg-gradient-to-br from-ts-terracotta/15 via-[#141312] to-[#141312] border border-ts-terracotta/30 flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
        ...
        <a
          ...
          className="shrink-0"
        >
          <Button size="lg" variant="whatsapp" icon={MessageSquare} className="font-bold text-xs sm:text-sm px-6 py-3.5 shadow-glow-teal">
