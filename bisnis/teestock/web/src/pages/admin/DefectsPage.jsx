...
const INITIAL_DEFECTS = [
  {
    ...
    qty: 1,
    costLoss: 14750, // Biaya cetak film DTF + press
    responsibleStage: 'vendor_dtf',
    resolutionNotes: 'Film DTF buram garis raster putus. Diklaim retur cetak ulang gratis ke vendor.',
  ...
  },
  {
    ...
    qty: 1,
    costLoss: 38000, // Harga garmen NSA Softstyle
    responsibleStage: 'vendor_nsa',
    resolutionNotes: 'Terdapat lubang kecil jarum rajut di bagian ketiak. Kaos disisihkan untuk kain lap press.',
    date: new Date(Date.now() - 86400000 * 5).toISOString()
  }
];

export function DefectsPage() {
  const { catalog, orders, showToast } = useAdmin();
  ...
  const handleAddDefect = async (e) => {
    ...
    showToast('✅ Catatan defect berhasil disimpan');
    setNewNotes('');
  };
