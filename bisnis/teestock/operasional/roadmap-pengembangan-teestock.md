...
> **Model Eksekusi:** Solopreneur Lean Framework (1 Founder, 3 Bisnis)

Dokumen ini memetakan tahapan pengembangan TeeStock dari rilis perdana hingga menjadi rumah apparel dan merchandise terpercaya. Seluruh tahapan disusun dengan mempertimbangkan batasan sumber daya (waktu, tenaga, modal) seorang solopreneur, dengan prinsip: **hanya naik kelas ke fase berikutnya setelah fase berjalan mencapai *Exit Criteria*.**

---

## Ringkasan 4 Fase Pengembangan
...
## Alokasi Waktu Harian/Mingguan Solopreneur

Sebagai pengelola 3 bisnis, gunakan pembagian waktu berikut agar tidak kelelahan:

| Waktu | Porsi | Aktivitas Utama |
|---|---|---|
| **Pagi (08.00 - 10.00)** | 25% | CS WhatsApp, konfirmasi order masuk, cetak resi marketplace |
| **Siang (13.00 - 16.00)** | 40% | Produksi fisik: Heat press kaos, quality control, dan packing |
| **Sore (16.00 - 17.00)** | 15% | Drop paket ke agen ekspedisi (J&T/Shopee Express) |
| **Malam (19.30 - 21.00)** | 20% | Konten sosmed, upload video TikTok/Reels, riset desain Drop berikutnya |
