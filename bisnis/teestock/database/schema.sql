...
DROP TABLE IF EXISTS ts_procurements CASCADE;
DROP TABLE IF EXISTS ts_cash_ledger CASCADE;
DROP TABLE IF EXISTS ts_fixed_assets CASCADE;
DROP TABLE IF EXISTS ts_capital_investments CASCADE;
...
-- ====================================================================
-- BAGIAN 7: PENGADAAN BARANG (PROCUREMENTS) & BUKU KAS FOUNDER (CASH LEDGER)
-- Pemisahan Keuangan Bisnis vs Dompet Pribadi & Otomasi Moving Average Cost
-- ====================================================================

-- 14. TABEL: ts_procurements (Pencatatan Belanja Bahan & Barang)
...
-- 15. TABEL: ts_cash_ledger (Buku Kas Satu Pintu Pemisahan Kas Bisnis vs Dompet Pribadi)
...
-- 16. FUNCTION & TRIGGER: Update Otomatis Moving Average Cost ke Inventory & Sinkronisasi Kas
...
-- 17. RLS POLICIES: Keamanan Data Keuangan (Hanya Admin)
...
-- ====================================================================
-- BAGIAN 8: MODUL EKSEKUTIF FOUNDER (ASET TETAP & ARUS MODAL PEMILIK)
-- Pelacak Kekayaan Bersih Bisnis, CAPEX, Injeksi Modal & Prive
-- ====================================================================

-- 18. TABEL: ts_fixed_assets (Alat Produksi, Mesin & Peralatan Kerja / CAPEX)
...
-- 19. TABEL: ts_capital_investments (Arus Ekuitas Modal Founder: Injeksi vs Prive)
...
-- 20. VIEW: ts_view_founder_wealth (Neraca Kasat Mata & Pertumbuhan Kekayaan Bisnis)
...
VALUES
('CAP-2609-001', 'INJECTION', 5000000, 'Tabungan Pribadi Founder', CURRENT_DATE, 'Setoran modal awal pembentukan bisnis TeeStock (Mesin Heat Press + Persediaan Bahan)')
ON CONFLICT (transaction_no) DO NOTHING;

-- Catat saldo modal awal ke buku kas
...
-- ====================================================================
-- 22. FUNGSI TRANSAKSI ATOMIK: create_order_transactional
-- ====================================================================
