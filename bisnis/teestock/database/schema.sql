...
CREATE TABLE ts_inventory (
    ...
    supplier VARCHAR(100) DEFAULT 'Official Cititex',
    updated_at TIMESTAMPTZ DEFAULT NOW()
);
...
('TS-BLK-72Y00', 'New States Apparel Youth T-Shirt 72Y00', 'blank', 'NSA Blank Apparel', '#EBE3D5', 'Kaos Polos Anak Katun Combed 24s', 'Katalog Polos', 'blank', 'active', 'Official Cititex', 'https://cititex.com/api/uploads/category/album/front_side/129-Black.jpg', 'Black, White, Navy, Red, Royal Blue, Daisy, Heliconia', 'YXS, YS, YM, YL, YXL', 47000, 39000, 35000, 0, false, 129, 'Kaos Polos Anak NSA Youth 72Y00 Katun 24s Cititex — TeeStock', 'Kaos polos anak New States Apparel Youth 72Y00. 100% Premium Cotton Combed 24s aman dan nyaman untuk kulit anak-anak. Kerah rib elastis dan tanpa jahitan samping.')
...
VALUES
('NSA-30S-BLK-M', 'blank_tshirt', 'New States Apparel', 'Hitam', 'M', 8, 3, 38000, 'Official Cititex'),
('NSA-30S-BLK-L', 'blank_tshirt', 'New States Apparel', 'Hitam', 'L', 10, 3, 38000, 'Official Cititex'),
('NSA-30S-BLK-XL', 'blank_tshirt', 'New States Apparel', 'Hitam', 'XL', 6, 2, 38000, 'Official Cititex'),
('NSA-30S-CRM-M', 'blank_tshirt', 'New States Apparel', 'Krem', 'M', 5, 2, 38000, 'Official Cititex'),
('NSA-30S-CRM-L', 'blank_tshirt', 'New States Apparel', 'Krem', 'L', 6, 2, 38000, 'Official Cititex'),
('NSA-24S-BLK-L', 'blank_tshirt', 'New States Apparel', 'Hitam', 'L', 8, 3, 48000, 'Official Cititex'),
('NSA-24S-BLK-XL', 'blank_tshirt', 'New States Apparel', 'Hitam', 'XL', 5, 2, 48000, 'Official Cititex'),
('NSA-20S-BLK-L', 'blank_tshirt', 'New States Apparel', 'Hitam', 'L', 5, 2, 65000, 'Official Cititex'),
